    ...
    renderProduct = () => {
        const jsx = this.arrProduct.map((item, index) => {
            return <div className="col-4 mt-5" key={index}>
                <ProductItems product={item}></ProductItems>
            </div>
        })
        return jsx;
    }
    ...
    render() {
        return (
            ...
            <div className="container-fluid" style={{ height: '100vh' }}>
                <div className='row'>
                    <div style={{ minHeight: '100vh' }} className="col-3 nav flex-column nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <div style={{ minHeight: '100vh' }} className="col-9 tab-content" id="v-pills-tabContent">
